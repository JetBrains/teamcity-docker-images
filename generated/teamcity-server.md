...
```
docker build -f "generated/linux/Server/Ubuntu/18.04/Dockerfile" -t teamcity-server:2020.1.5-linux "context"
```
...
```
docker build -f "generated/windows/Server/nanoserver/1809/Dockerfile" -t teamcity-server:2020.1.5-nanoserver-1809 "context"
```
...
```
docker build -f "generated/windows/Server/nanoserver/1903/Dockerfile" -t teamcity-server:2020.1.5-nanoserver-1903 "context"
```
...
```
docker build -f "generated/windows/Server/nanoserver/1803/Dockerfile" -t teamcity-server:2020.1.5-nanoserver-1803 "context"
```
...
```
docker build -f "generated/windows/Server/nanoserver/1909/Dockerfile" -t teamcity-server:2020.1.5-nanoserver-1909 "context"
```
