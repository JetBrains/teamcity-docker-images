...
- 20.04-sudo
  - [local-linux-arm64-sudo](#local-linux-arm64-sudo)
  - [local-linux-sudo](#local-linux-sudo)
- 20.04
  - [local-linux](#local-linux)
  - [local-linux-arm64](#local-linux-arm64)
- 18.04-sudo
  - [local-linux-18.04-sudo](#local-linux-1804-sudo)
  - [local-linux-arm64-18.04-sudo](#local-linux-arm64-1804-sudo)
- 18.04
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "generated/linux/MinimalAgent/UbuntuARM/20.04/Dockerfile" -t teamcity-minimal-agent:local-linux-arm64 "context"
echo 2> context/.dockerignore
echo TeamCity >> context/.dockerignore
docker build -f "generated/linux/Agent/UbuntuARM/20.04/Dockerfile" -t teamcity-agent:local-linux-arm64 "context"
```

_The required free space to generate image(s) is about **2 GB**._

### local-linux-arm64-sudo
...
echo TeamCity >> context/.dockerignore
docker build -f "generated/linux/Agent/UbuntuARM/20.04/Dockerfile" -t teamcity-agent:local-linux-arm64 "context"
docker build -f "generated/linux/Agent/UbuntuARM/20.04-sudo/Dockerfile" -t teamcity-agent:local-linux-arm64-sudo "context"
```
...
echo 2> context/.dockerignore
echo TeamCity >> context/.dockerignore
docker build -f "generated/linux/Agent/UbuntuARM/18.04/Dockerfile" -t teamcity-agent:local-linux-arm64-18.04 "context"
```

_The required free space to generate image(s) is about **2 GB**._

### local-linux-arm64-18.04-sudo
...
echo TeamCity >> context/.dockerignore
docker build -f "generated/linux/Agent/UbuntuARM/18.04/Dockerfile" -t teamcity-agent:local-linux-arm64-18.04 "context"
docker build -f "generated/linux/Agent/UbuntuARM/18.04-sudo/Dockerfile" -t teamcity-agent:local-linux-arm64-18.04-sudo "context"
```
