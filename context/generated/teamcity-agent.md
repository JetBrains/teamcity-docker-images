...
- [2020.2.3-windowsservercore](#202023-windowsservercore)

#### linux

- 20.04-sudo
  - [2020.2.3-linux-sudo](#202023-linux-sudo)
- 20.04-dotnet
  - [linux-dotnet](#linux-dotnet)
- 20.04
  - [2020.2.3-linux](#202023-linux)
- 18.04-sudo
  - [2020.2.3-linux-18.04-sudo](#202023-linux-1804-sudo)
- 18.04
...
- 2004
  ...
  - [2020.2.3-windowsservercore-2004](#202023-windowsservercore-2004)
- 1909
  - [2020.2.3-nanoserver-1909](#202023-nanoserver-1909)
  - [2020.2.3-windowsservercore-1909](#202023-windowsservercore-1909)
- 1903
  - [2020.2.3-nanoserver-1903](#202023-nanoserver-1903)
  - [2020.2.3-windowsservercore-1903](#202023-windowsservercore-1903)
- 1809-dotnet
  - [nanoserver-dotnet](#nanoserver-dotnet)
- 1809
  - [2020.2.3-nanoserver-1809](#202023-nanoserver-1809)
  - [2020.2.3-windowsservercore-1809](#202023-windowsservercore-1809)
- 1803
  - [2020.2.3-nanoserver-1803](#202023-nanoserver-1803)
  - [2020.2.3-windowsservercore-1803](#202023-windowsservercore-1803)
...
docker build -f "context/generated/linux/Agent/Ubuntu/20.04/Dockerfile" -t teamcity-agent:2020.2.3-linux "context"
```
...
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/20.04/Dockerfile" -t teamcity-agent:2020.2.3-linux "context"
docker build -f "context/generated/linux/Agent/Ubuntu/20.04-sudo/Dockerfile" -t teamcity-agent:2020.2.3-linux-sudo "context"
```
...
docker build -f "context/generated/windows/Agent/windowsservercore/1809/Dockerfile" -t teamcity-agent:2020.2.3-windowsservercore-1809 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1809/Dockerfile" -t teamcity-agent:2020.2.3-nanoserver-1809 "context"
```
...
docker build -f "context/generated/windows/Agent/windowsservercore/2004/Dockerfile" -t teamcity-agent:2020.2.3-windowsservercore-2004 "context"
docker build -f "context/generated/windows/Agent/nanoserver/2004/Dockerfile" -t teamcity-agent:2020.2.3-nanoserver-2004 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.3-windowsservercore-1809
...
### 2020.2.3-windowsservercore-2004
...
echo 2> context/.dockerignore
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/18.04/Dockerfile" -t teamcity-agent:2020.2.3-linux-18.04 "context"
```

_The required free space to generate image(s) is about **2 GB**._

### 2020.2.3-linux-18.04-sudo
...
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/18.04/Dockerfile" -t teamcity-agent:2020.2.3-linux-18.04 "context"
docker build -f "context/generated/linux/Agent/Ubuntu/18.04-sudo/Dockerfile" -t teamcity-agent:2020.2.3-linux-18.04-sudo "context"
```
...
docker build -f "context/generated/windows/Agent/windowsservercore/1803/Dockerfile" -t teamcity-agent:2020.2.3-windowsservercore-1803 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1803/Dockerfile" -t teamcity-agent:2020.2.3-nanoserver-1803 "context"
```
...
docker build -f "context/generated/windows/Agent/windowsservercore/1903/Dockerfile" -t teamcity-agent:2020.2.3-windowsservercore-1903 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1903/Dockerfile" -t teamcity-agent:2020.2.3-nanoserver-1903 "context"
```
...
docker build -f "context/generated/windows/Agent/windowsservercore/1909/Dockerfile" -t teamcity-agent:2020.2.3-windowsservercore-1909 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1909/Dockerfile" -t teamcity-agent:2020.2.3-nanoserver-1909 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.3-windowsservercore-1803
...
### 2020.2.3-windowsservercore-1903
...
### 2020.2.3-windowsservercore-1909
...
```
docker pull jetbrains/teamcity-agent:2020.2.3-nanoserver-1809
echo TeamCity > context/.dockerignore
