...
- [2020.2.2-windowsservercore](#202022-windowsservercore)

#### linux

- 20.04-sudo
  - [2020.2.2-linux-sudo](#202022-linux-sudo)
- 20.04-dotnet
  - [linux-dotnet](#linux-dotnet)
- 20.04
  - [2020.2.2-linux](#202022-linux)
- 18.04-sudo
  - [2020.2.2-linux-18.04-sudo](#202022-linux-1804-sudo)
- 18.04
  - [2020.2.2-linux-18.04](#202022-linux-1804)

#### windows

- 2004
  - [2020.2.2-nanoserver-2004](#202022-nanoserver-2004)
  - [2020.2.2-windowsservercore-2004](#202022-windowsservercore-2004)
- 1909
  - [2020.2.2-nanoserver-1909](#202022-nanoserver-1909)
  - [2020.2.2-windowsservercore-1909](#202022-windowsservercore-1909)
- 1903
  - [2020.2.2-nanoserver-1903](#202022-nanoserver-1903)
  - [2020.2.2-windowsservercore-1903](#202022-windowsservercore-1903)
- 1809-dotnet
  - [nanoserver-dotnet](#nanoserver-dotnet)
- 1809
  - [2020.2.2-nanoserver-1809](#202022-nanoserver-1809)
  - [2020.2.2-windowsservercore-1809](#202022-windowsservercore-1809)
- 1803
  - [2020.2.2-nanoserver-1803](#202022-nanoserver-1803)
  - [2020.2.2-windowsservercore-1803](#202022-windowsservercore-1803)
...
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/20.04/Dockerfile" -t teamcity-agent:2020.2.2-linux "context"
docker build -f "context/generated/linux/Agent/Ubuntu/20.04-sudo/Dockerfile" -t teamcity-agent:2020.2.2-linux-sudo "context"
```

_The required free space to generate image(s) is about **3 GB**._

### 2020.2.2-nanoserver-1809
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/windows/MinimalAgent/nanoserver/1809/Dockerfile" -t teamcity-minimal-agent:2020.2.2-nanoserver-1809 "context"
docker build -f "context/generated/windows/Agent/windowsservercore/1809/Dockerfile" -t teamcity-agent:2020.2.2-windowsservercore-1809 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1809/Dockerfile" -t teamcity-agent:2020.2.2-nanoserver-1809 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.2-nanoserver-2004
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/windows/MinimalAgent/nanoserver/2004/Dockerfile" -t teamcity-minimal-agent:2020.2.2-nanoserver-2004 "context"
docker build -f "context/generated/windows/Agent/windowsservercore/2004/Dockerfile" -t teamcity-agent:2020.2.2-windowsservercore-2004 "context"
docker build -f "context/generated/windows/Agent/nanoserver/2004/Dockerfile" -t teamcity-agent:2020.2.2-nanoserver-2004 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.2-windowsservercore-1809
...
### 2020.2.2-windowsservercore-2004
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/linux/MinimalAgent/Ubuntu/18.04/Dockerfile" -t teamcity-minimal-agent:2020.2.2-linux-18.04 "context"
echo 2> context/.dockerignore
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/18.04/Dockerfile" -t teamcity-agent:2020.2.2-linux-18.04 "context"
```

_The required free space to generate image(s) is about **2 GB**._

### 2020.2.2-linux-18.04-sudo
...
echo TeamCity >> context/.dockerignore
docker build -f "context/generated/linux/Agent/Ubuntu/18.04/Dockerfile" -t teamcity-agent:2020.2.2-linux-18.04 "context"
docker build -f "context/generated/linux/Agent/Ubuntu/18.04-sudo/Dockerfile" -t teamcity-agent:2020.2.2-linux-18.04-sudo "context"
```
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/windows/MinimalAgent/nanoserver/1803/Dockerfile" -t teamcity-minimal-agent:2020.2.2-nanoserver-1803 "context"
docker build -f "context/generated/windows/Agent/windowsservercore/1803/Dockerfile" -t teamcity-agent:2020.2.2-windowsservercore-1803 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1803/Dockerfile" -t teamcity-agent:2020.2.2-nanoserver-1803 "context"
```

_The required free space to generate image(s) is about **33 GB**._

### 2020.2.2-nanoserver-1903
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/windows/MinimalAgent/nanoserver/1903/Dockerfile" -t teamcity-minimal-agent:2020.2.2-nanoserver-1903 "context"
docker build -f "context/generated/windows/Agent/windowsservercore/1903/Dockerfile" -t teamcity-agent:2020.2.2-windowsservercore-1903 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1903/Dockerfile" -t teamcity-agent:2020.2.2-nanoserver-1903 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.2-nanoserver-1909
...
echo TeamCity/devPackage >> context/.dockerignore
echo TeamCity/lib >> context/.dockerignore
docker build -f "context/generated/windows/MinimalAgent/nanoserver/1909/Dockerfile" -t teamcity-minimal-agent:2020.2.2-nanoserver-1909 "context"
docker build -f "context/generated/windows/Agent/windowsservercore/1909/Dockerfile" -t teamcity-agent:2020.2.2-windowsservercore-1909 "context"
docker build -f "context/generated/windows/Agent/nanoserver/1909/Dockerfile" -t teamcity-agent:2020.2.2-nanoserver-1909 "context"
```

_The required free space to generate image(s) is about **35 GB**._

### 2020.2.2-windowsservercore-1803
...
### 2020.2.2-windowsservercore-1903
...
### 2020.2.2-windowsservercore-1909
