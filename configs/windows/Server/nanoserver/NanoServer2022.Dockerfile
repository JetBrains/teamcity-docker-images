...
RUN cmd /c icacls.exe C:\\TeamCity\\* /grant:r DefaultAccount:(OI)(CI)F /grant:r DefaultAccount:(OI)(CI)D
RUN cmd /c icacls.exe C:\\TeamCity\\* /grant:r Users:(OI)(CI)F /grant:r Users:(OI)(CI)D
USER ContainerUser