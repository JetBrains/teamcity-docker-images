...
object push_local_windows_1803 : BuildType({
	 ...
	 description  = "teamcity-server:2022.10.4-nanoserver-1803,${latestTag},2022.10.4 teamcity-minimal-agent:2022.10.4-nanoserver-1803,${latestTag},2022.10.4 teamcity-agent:2022.10.4-windowsservercore-1803,2022.10.4-windowsservercore,${latestTag}-windowsservercore:2022.10.4-nanoserver-1803,${latestTag},2022.10.4"
})
