...
object push_local_windows_1903 : BuildType({
	 ...
	 description  = "teamcity-server:2022.10.5-nanoserver-1903,${latestTag},2022.10.5 teamcity-minimal-agent:2022.10.5-nanoserver-1903,${latestTag},2022.10.5 teamcity-agent:2022.10.5-windowsservercore-1903,2022.10.5-windowsservercore,${latestTag}-windowsservercore:2022.10.5-nanoserver-1903,${latestTag},2022.10.5"
})
