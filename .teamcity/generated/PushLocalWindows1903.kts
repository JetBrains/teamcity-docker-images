...
object push_local_windows_1903 : BuildType({
	 ...
	 description  = "teamcity-server:2022.10.4-nanoserver-1903,${latestTag},2022.10.4 teamcity-minimal-agent:2022.10.4-nanoserver-1903,${latestTag},2022.10.4 teamcity-agent:2022.10.4-windowsservercore-1903,2022.10.4-windowsservercore,${latestTag}-windowsservercore:2022.10.4-nanoserver-1903,${latestTag},2022.10.4"
})
