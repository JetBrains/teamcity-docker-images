...
object push_local_windows_1909 : BuildType({
	 ...
	 description  = "teamcity-server:2022.10.5-nanoserver-1909,${latestTag},2022.10.5 teamcity-minimal-agent:2022.10.5-nanoserver-1909,${latestTag},2022.10.5 teamcity-agent:2022.10.5-windowsservercore-1909,2022.10.5-windowsservercore,${latestTag}-windowsservercore:2022.10.5-nanoserver-1909,${latestTag},2022.10.5"
})
