...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-server:latest %docker.deployRepository%teamcity-server:2021.2.2-linux %docker.deployRepository%teamcity-server:2021.2.2-nanoserver-1809 %docker.deployRepository%teamcity-server:2021.2.2-nanoserver-2004"
}
}
dockerCommand {
...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-agent:latest %docker.deployRepository%teamcity-agent:2021.2.2-linux %docker.deployRepository%teamcity-agent:2021.2.2-nanoserver-1809 %docker.deployRepository%teamcity-agent:2021.2.2-nanoserver-2004"
}
}
dockerCommand {
...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-minimal-agent:latest %docker.deployRepository%teamcity-minimal-agent:2021.2.2-linux %docker.deployRepository%teamcity-minimal-agent:2021.2.2-nanoserver-1809 %docker.deployRepository%teamcity-minimal-agent:2021.2.2-nanoserver-2004"
}
}
dockerCommand {
