...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-server:latest %docker.deployRepository%teamcity-server:2020.2.4-linux %docker.deployRepository%teamcity-server:2020.2.4-nanoserver-1809 %docker.deployRepository%teamcity-server:2020.2.4-nanoserver-2004"
}
}
dockerCommand {
...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-agent:latest %docker.deployRepository%teamcity-agent:2020.2.4-linux %docker.deployRepository%teamcity-agent:2020.2.4-nanoserver-1809 %docker.deployRepository%teamcity-agent:2020.2.4-nanoserver-2004"
}
}
dockerCommand {
...
commandType = other {
subCommand = "manifest"
commandArgs = "create %docker.deployRepository%teamcity-minimal-agent:latest %docker.deployRepository%teamcity-minimal-agent:2020.2.4-linux %docker.deployRepository%teamcity-minimal-agent:2020.2.4-nanoserver-1809 %docker.deployRepository%teamcity-minimal-agent:2020.2.4-nanoserver-2004"
}
}
dockerCommand {
