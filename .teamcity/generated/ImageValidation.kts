...
"teamcity-server-2023.05-linux" to "%docker.deployRepository%teamcity-server%docker.buildImagePostfix%:2023.05-linux", 
		"teamcity-agent-2023.05-linux" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-linux", 
		"teamcity-agent-2023.05-linux-sudo" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-linux-sudo", 
		"teamcity-minimal-agent-2023.05-linux" to "%docker.deployRepository%teamcity-minimal-agent%docker.buildImagePostfix%:2023.05-linux", 
		"teamcity-server-2023.05-nanoserver-1809" to "%docker.deployRepository%teamcity-server%docker.buildImagePostfix%:2023.05-nanoserver-1809", 
		"teamcity-agent-2023.05-windowsservercore-1809" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-windowsservercore-1809", 
		"teamcity-agent-2023.05-nanoserver-1809" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-nanoserver-1809", 
		"teamcity-minimal-agent-2023.05-nanoserver-1809" to "%docker.deployRepository%teamcity-minimal-agent%docker.buildImagePostfix%:2023.05-nanoserver-1809", 
		"teamcity-server-2023.05-nanoserver-2004" to "%docker.deployRepository%teamcity-server%docker.buildImagePostfix%:2023.05-nanoserver-2004", 
		"teamcity-agent-2023.05-windowsservercore-2004" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-windowsservercore-2004", 
		"teamcity-agent-2023.05-nanoserver-2004" to "%docker.deployRepository%teamcity-agent%docker.buildImagePostfix%:2023.05-nanoserver-2004", 
		"teamcity-minimal-agent-2023.05-nanoserver-2004" to "%docker.deployRepository%teamcity-minimal-agent%docker.buildImagePostfix%:2023.05-nanoserver-2004"
	  )
