...
description  = "teamcity-server:2022.04.7-nanoserver-1809,,2022.04.7 teamcity-minimal-agent:2022.04.7-nanoserver-1809,,2022.04.7 teamcity-agent:2022.04.7-windowsservercore-1809,2022.04.7-windowsservercore,-windowsservercore:2022.04.7-nanoserver-1809,,2022.04.7"
...
script {
name = "context teamcity-server:2022.04.7-nanoserver-1809"
scriptContent = """
...
dockerCommand {
name = "build teamcity-server:2022.04.7-nanoserver-1809"
commandType = build {
source = file {
...
namesAndTags = """
teamcity-server:2022.04.7-nanoserver-1809
""".trimIndent()
}
...
script {
name = "context teamcity-minimal-agent:2022.04.7-nanoserver-1809"
scriptContent = """
echo 2> context/.dockerignore
...
dockerCommand {
name = "build teamcity-minimal-agent:2022.04.7-nanoserver-1809"
commandType = build {
source = file {
...
commandArgs = "--no-cache"
namesAndTags = """
teamcity-minimal-agent:2022.04.7-nanoserver-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
...
script {
name = "context teamcity-agent:2022.04.7-windowsservercore-1809"
scriptContent = """
echo 2> context/.dockerignore
echo TeamCity/webapps >> context/.dockerignore
echo TeamCity/devPackage >> context/.dockerignore
...
dockerCommand {
name = "build teamcity-agent:2022.04.7-windowsservercore-1809"
commandType = build {
source = file {
...
commandArgs = "--no-cache"
namesAndTags = """
teamcity-agent:2022.04.7-windowsservercore-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
...
script {
name = "context teamcity-agent:2022.04.7-nanoserver-1809"
scriptContent = """
echo 2> context/.dockerignore
echo TeamCity/webapps >> context/.dockerignore
echo TeamCity/devPackage >> context/.dockerignore
...
dockerCommand {
name = "build teamcity-agent:2022.04.7-nanoserver-1809"
commandType = build {
source = file {
...
commandArgs = "--no-cache"
namesAndTags = """
teamcity-agent:2022.04.7-nanoserver-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
