...
description  = "teamcity-server:2020.2-nanoserver-1809,latest,2020.2 teamcity-minimal-agent:2020.2-nanoserver-1809,latest,2020.2 teamcity-agent:2020.2-windowsservercore-1809,2020.2-windowsservercore,latest-windowsservercore:2020.2-nanoserver-1809,latest,2020.2"
...
script {
name = "context teamcity-server:2020.2-nanoserver-1809"
scriptContent = """
...
dockerCommand {
name = "build teamcity-server:2020.2-nanoserver-1809"
commandType = build {
source = file {
...
contextDir = "context"
namesAndTags = """
teamcity-server:2020.2-nanoserver-1809
""".trimIndent()
}
...
script {
name = "context teamcity-minimal-agent:2020.2-nanoserver-1809"
scriptContent = """
echo 2> context/.dockerignore
...
dockerCommand {
name = "build teamcity-minimal-agent:2020.2-nanoserver-1809"
commandType = build {
source = file {
...
contextDir = "context"
namesAndTags = """
teamcity-minimal-agent:2020.2-nanoserver-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
...
script {
name = "context teamcity-agent:2020.2-windowsservercore-1809"
scriptContent = """
echo 2> context/.dockerignore
echo TeamCity/webapps >> context/.dockerignore
echo TeamCity/devPackage >> context/.dockerignore
...
dockerCommand {
name = "build teamcity-agent:2020.2-windowsservercore-1809"
commandType = build {
source = file {
...
contextDir = "context"
namesAndTags = """
teamcity-agent:2020.2-windowsservercore-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
...
script {
name = "context teamcity-agent:2020.2-nanoserver-1809"
scriptContent = """
echo 2> context/.dockerignore
echo TeamCity/webapps >> context/.dockerignore
echo TeamCity/devPackage >> context/.dockerignore
...
dockerCommand {
name = "build teamcity-agent:2020.2-nanoserver-1809"
commandType = build {
source = file {
...
contextDir = "context"
namesAndTags = """
teamcity-agent:2020.2-nanoserver-1809
""".trimIndent()
}
param("dockerImage.platform", "windows")
}
