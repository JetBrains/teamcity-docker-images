...
description  = "teamcity-agent:latest-nanoserver-1903:latest-windowsservercore-1903 teamcity-minimal-agent:latest-nanoserver-1903 teamcity-server:latest-nanoserver-1903"
...
description  = "teamcity-agent:latest-nanoserver-1809:latest-windowsservercore-1809 teamcity-minimal-agent:latest-nanoserver-1809 teamcity-server:latest-nanoserver-1809"
vcs {root(RemoteTeamcityImages)}
steps {
dockerCommand {
...
description  = "teamcity-agent:18.04,linux:18.04-sudo teamcity-minimal-agent:18.04,linux teamcity-server:18.04,linux"
vcs {root(RemoteTeamcityImages)}
steps {
dockerCommand {
