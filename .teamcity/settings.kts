...
dockerCommand {
name = "tag teamcity-server:2020.1-18.04"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-server:18.04 %docker.pushRepository%teamcity-server:2020.1-18.04"
}
}

dockerCommand {
name = "tag teamcity-server:2020.1-linux"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-server:linux %docker.pushRepository%teamcity-server:2020.1-linux"
}
}

dockerCommand {
name = "tag teamcity-minimal-agent:2020.1-18.04"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-minimal-agent:18.04 %docker.pushRepository%teamcity-minimal-agent:2020.1-18.04"
}
}

dockerCommand {
name = "tag teamcity-minimal-agent:2020.1-linux"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-minimal-agent:linux %docker.pushRepository%teamcity-minimal-agent:2020.1-linux"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-18.04"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:18.04 %docker.pushRepository%teamcity-agent:2020.1-18.04"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-linux"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:linux %docker.pushRepository%teamcity-agent:2020.1-linux"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-18.04-sudo"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:18.04-sudo %docker.pushRepository%teamcity-agent:2020.1-18.04-sudo"
}
}
...
dockerCommand {
name = "push teamcity-server:latest-18.04,2020.1-18.04,eap-18.04,latest-linux,2020.1-linux,eap-linux"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-server:latest-18.04
%docker.pushRepository%teamcity-server:2020.1-18.04
%docker.pushRepository%teamcity-server:eap-18.04
%docker.pushRepository%teamcity-server:latest-linux
%docker.pushRepository%teamcity-server:2020.1-linux
...
dockerCommand {
name = "push teamcity-minimal-agent:latest-18.04,2020.1-18.04,eap-18.04,latest-linux,2020.1-linux,eap-linux"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-minimal-agent:latest-18.04
%docker.pushRepository%teamcity-minimal-agent:2020.1-18.04
%docker.pushRepository%teamcity-minimal-agent:eap-18.04
%docker.pushRepository%teamcity-minimal-agent:latest-linux
%docker.pushRepository%teamcity-minimal-agent:2020.1-linux
...
dockerCommand {
name = "push teamcity-agent:latest-18.04,2020.1-18.04,eap-18.04,latest-linux,2020.1-linux,eap-linux"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-18.04
%docker.pushRepository%teamcity-agent:2020.1-18.04
%docker.pushRepository%teamcity-agent:eap-18.04
%docker.pushRepository%teamcity-agent:latest-linux
%docker.pushRepository%teamcity-agent:2020.1-linux
...
dockerCommand {
name = "push teamcity-agent:latest-18.04-sudo,2020.1-18.04-sudo,eap-18.04-sudo"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-18.04-sudo
%docker.pushRepository%teamcity-agent:2020.1-18.04-sudo
...
object TC_Trunk_BuildDist_nanoserver_1809 : BuildType({
...
dockerCommand {
name = "tag teamcity-server:2020.1-nanoserver-1809"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-server:nanoserver-1809 %docker.pushRepository%teamcity-server:2020.1-nanoserver-1809"
}
}

dockerCommand {
name = "tag teamcity-minimal-agent:2020.1-nanoserver-1809"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-minimal-agent:nanoserver-1809 %docker.pushRepository%teamcity-minimal-agent:2020.1-nanoserver-1809"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-windowsservercore-1809"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:windowsservercore-1809 %docker.pushRepository%teamcity-agent:2020.1-windowsservercore-1809"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-nanoserver-1809"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:nanoserver-1809 %docker.pushRepository%teamcity-agent:2020.1-nanoserver-1809"
}
}
...
dockerCommand {
name = "push teamcity-server:latest-nanoserver-1809,2020.1-nanoserver-1809,eap-nanoserver-1809"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-server:latest-nanoserver-1809
%docker.pushRepository%teamcity-server:2020.1-nanoserver-1809
...
dockerCommand {
name = "push teamcity-minimal-agent:latest-nanoserver-1809,2020.1-nanoserver-1809,eap-nanoserver-1809"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-minimal-agent:latest-nanoserver-1809
%docker.pushRepository%teamcity-minimal-agent:2020.1-nanoserver-1809
...
dockerCommand {
name = "push teamcity-agent:latest-windowsservercore-1809,2020.1-windowsservercore-1809,eap-windowsservercore-1809"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-windowsservercore-1809
%docker.pushRepository%teamcity-agent:2020.1-windowsservercore-1809
...
dockerCommand {
name = "push teamcity-agent:latest-nanoserver-1809,2020.1-nanoserver-1809,eap-nanoserver-1809"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-nanoserver-1809
%docker.pushRepository%teamcity-agent:2020.1-nanoserver-1809
...
object TC_Trunk_BuildDist_nanoserver_1903 : BuildType({
...
dockerCommand {
name = "tag teamcity-server:2020.1-nanoserver-1903"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-server:nanoserver-1903 %docker.pushRepository%teamcity-server:2020.1-nanoserver-1903"
}
}

dockerCommand {
name = "tag teamcity-minimal-agent:2020.1-nanoserver-1903"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-minimal-agent:nanoserver-1903 %docker.pushRepository%teamcity-minimal-agent:2020.1-nanoserver-1903"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-windowsservercore-1903"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:windowsservercore-1903 %docker.pushRepository%teamcity-agent:2020.1-windowsservercore-1903"
}
}

dockerCommand {
name = "tag teamcity-agent:2020.1-nanoserver-1903"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:nanoserver-1903 %docker.pushRepository%teamcity-agent:2020.1-nanoserver-1903"
}
}
...
dockerCommand {
name = "push teamcity-server:latest-nanoserver-1903,2020.1-nanoserver-1903,eap-nanoserver-1903"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-server:latest-nanoserver-1903
%docker.pushRepository%teamcity-server:2020.1-nanoserver-1903
...
dockerCommand {
name = "push teamcity-minimal-agent:latest-nanoserver-1903,2020.1-nanoserver-1903,eap-nanoserver-1903"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-minimal-agent:latest-nanoserver-1903
%docker.pushRepository%teamcity-minimal-agent:2020.1-nanoserver-1903
...
dockerCommand {
name = "push teamcity-agent:latest-windowsservercore-1903,2020.1-windowsservercore-1903,eap-windowsservercore-1903"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-windowsservercore-1903
%docker.pushRepository%teamcity-agent:2020.1-windowsservercore-1903
...
dockerCommand {
name = "push teamcity-agent:latest-nanoserver-1903,2020.1-nanoserver-1903,eap-nanoserver-1903"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:latest-nanoserver-1903
%docker.pushRepository%teamcity-agent:2020.1-nanoserver-1903
...
object TC_Trunk_BuildDist_latest_publish: BuildType(
{
name = "Publish latest"
steps {
dockerCommand {
...
snapshot(TC_Trunk_BuildDist_nanoserver_1809)
{
onDependencyFailure = FailureAction.IGNORE
}
...
buildType(TC_Trunk_BuildDist_latest_publish)
buildType(TC_Trunk_BuildDist_2020_1_publish)
buildType(TC_Trunk_BuildDist_eap_publish)
buildType(TC_Trunk_BuildDist_18_04_linux)
buildType(TC_Trunk_BuildDist_nanoserver_1809)
buildType(TC_Trunk_BuildDist_nanoserver_1903)
}
