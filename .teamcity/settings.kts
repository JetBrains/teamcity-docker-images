...
dockerCommand {
name = "change tag from teamcity-server:latest-nanoserver-1803 to 2019_2-latest-nanoserver-1803"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-server:latest-nanoserver-1803 %docker.pushRepository%teamcity-server:2019_2-latest-nanoserver-1803"
}
}

dockerCommand {
name = "change tag from teamcity-minimal-agent:latest-nanoserver-1803 to 2019_2-latest-nanoserver-1803"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-minimal-agent:latest-nanoserver-1803 %docker.pushRepository%teamcity-minimal-agent:2019_2-latest-nanoserver-1803"
}
}

dockerCommand {
name = "change tag from teamcity-agent:latest-windowsservercore-1803 to 2019_2-latest-windowsservercore-1803"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:latest-windowsservercore-1803 %docker.pushRepository%teamcity-agent:2019_2-latest-windowsservercore-1803"
}
}

dockerCommand {
name = "change tag from teamcity-agent:latest-nanoserver-1803 to 2019_2-latest-nanoserver-1803"
commandType = other {
subCommand = "tag"
commandArgs = "teamcity-agent:latest-nanoserver-1803 %docker.pushRepository%teamcity-agent:2019_2-latest-nanoserver-1803"
}
}

dockerCommand {
name = "push teamcity-server:2019_2-latest-nanoserver-1803"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-server:2019_2-latest-nanoserver-1803
""".trimIndent()
}
}

dockerCommand {
name = "push teamcity-minimal-agent:2019_2-latest-nanoserver-1803"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-minimal-agent:2019_2-latest-nanoserver-1803
""".trimIndent()
}
}

dockerCommand {
name = "push teamcity-agent:2019_2-latest-windowsservercore-1803"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:2019_2-latest-windowsservercore-1803
""".trimIndent()
}
}

dockerCommand {
name = "push teamcity-agent:2019_2-latest-nanoserver-1803"
commandType = push {
namesAndTags = """
%docker.pushRepository%teamcity-agent:2019_2-latest-nanoserver-1803
""".trimIndent()
}
}
